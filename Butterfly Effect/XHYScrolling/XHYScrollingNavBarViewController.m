...
//    self.overLay = [[UIView alloc] initWithFrame:self.navigationController.navigationBar.bounds];
    self.overLay = [[UIView alloc] initWithFrame:KRect(0, 0, self.view.frame.size.width, self.navigationController.navigationBar.bounds.size.height)];
...
//    }else{
//    
//        NSLog(@"----------other-",device.orientation);
//    }
