...
//        self.backgroundColor = [UIColor whiteColor];
        self.backgroundColor=[UIColor colorWithRed:1.0/255.0 green:27.0/255.0 blue:69.0/255.0 alpha:1];
//        self.backImageView=[UIImage imageNamed:@"background"];
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, kTitleYOffset+5, kAlertWidth, kTitleHeight)];
        self.alertTitleLabel.font = [UIFont fontWithName:FONTNAME3  size:18];
        self.alertContentLabel.font=[UIFont fontWithName:FONTNAME3 size:5];
...
//        self.alertContentLabel.font = [UIFont systemFontOfSize:15.0f];
        self.alertContentLabel.font=[UIFont fontWithName:FONTNAME size:13];
...
//            leftBtnFrame = CGRectMake((kAlertWidth - 2 * kCoupleButtonWidth - kButtonBottomOffset) * 0.5, kAlertHeight - kButtonBottomOffset - kButtonHeight, kCoupleButtonWidth, kButtonHeight);
            leftBtnFrame=CGRectMake(kAlertWidth/2-50, kAlertHeight - kButtonBottomOffset- kButtonHeight, 100, 30);
...
//        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:227.0/255.0 green:100.0/255.0 blue:83.0/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:GREEN] forState:UIControlStateNormal];
